...
class WarehouseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \DB::transaction(function () use ($request) {
            ...
            $Warehouse->telegram_bot_token = $request['telegram_bot_token'];
            $Warehouse->telegram_chat_id = $request['telegram_chat_id'];
            $Warehouse->telegram_enabled = $request['telegram_enabled'] ?? 0;
            $Warehouse->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        Warehouse::whereId($id)->update([
            ...
            'telegram_enabled' => $request['telegram_enabled'] ?? 0,
        ]);
