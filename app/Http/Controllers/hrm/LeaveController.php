...
class LeaveController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('attachment')) {
            ...
            $saved = media_put('leave', $filename, file_get_contents($image->getRealPath()), $image->getMimeType() ?: 'application/octet-stream');
            if (! $saved) {
                throw new \RuntimeException('Unable to save leave attachment to cloud storage.');
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->attachment != null) {
            if ($request->attachment != $CurrentAttachement && $request->hasFile('attachment')) {
                ...
                if ($leave->attachment != 'no_image.png') {
                    media_delete('leave', $CurrentAttachement);
                }
            } else {
