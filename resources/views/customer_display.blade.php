...
<head>
    ...
    <link rel="icon" href="{{ app_image_url(($app_settings->favicon ?? null) ?: null, asset('images/favicon.ico')) }}">
...
<body>
  ...
  <script>
    window.__APP_LOGO__ = '{{ app_image_url(($app_settings->logo ?? null) ?: null, asset('images/logo.png')) }}';
  </script>
