...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ app_image_url($app_settings->favicon ?? null, asset('images/favicon.ico')) }}">
  ...
  <body class="text-left">
    ...
    <div class="loading_wrap" id="loading_wrap">
      ...
      <img src="{{ app_image_url($app_settings->logo ?? null, asset('images/logo.png')) }}" class="" alt="logo" />
