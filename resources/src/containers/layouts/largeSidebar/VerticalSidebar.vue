        ...
        <ul class="nav-list">
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('reports') && !isCollapsed">
              ...
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('sales_by_seller_report')">
                <router-link to="/app/reports/sales_by_seller_report" class="submenu-link">
  ...
  computed: {
    ...mapGetters(["currentUserPermissions", "currentUser"]),
      ...
      const reportPermissions = [
        ...
        'Reports_sales', 'product_sales_report', 'sales_by_seller_report', 'product_purchases_report', 'Reports_suppliers',
