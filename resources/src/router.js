...
const baseRoutes = [
            ...
            // Reports
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        path: "sales_by_seller_report",
                        component: () =>
                            import(
                                /* webpackChunkName: "sales_by_seller_report" */
                                "./views/app/pages/reports/sales_by_seller_report"
                            )
                    },
                    {
    ...
    {
        path: "/app/not_authorize",
        alias: ["/not_authorize", "/app/reports/not_authorize"],
        name: "not_authorize",
        component: () =>
            import(
