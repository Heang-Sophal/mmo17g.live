      ...
      <b-modal hide-footer size="lg" id="New_Warehouse" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Warehouse">
          <b-row>
            ...
            <!-- Telegram Bot Token -->
            <b-col md="6">
              <b-form-group :label="'Telegram Bot Token'">
                <b-form-input
                  placeholder="123456789:ABCdefGHIjklMNOpqrsTUVwxyz"
                  label="Telegram Bot Token"
                  v-model="warehouse.telegram_bot_token"
                  type="password"
                ></b-form-input>
                <small class="form-text text-muted">Get from @BotFather on Telegram</small>
              </b-form-group>
            </b-col>
            ...
            <b-col md="6">
              <b-form-group :label="'Telegram Chat ID'">
                <b-form-input
                  ...
                  v-model="warehouse.telegram_chat_id"
                ></b-form-input>
                <small class="form-text text-muted">Get Chat ID from @userinfobot on Telegram</small>
              </b-form-group>
            </b-col>

            <!-- Telegram Enabled -->
            <b-col md="6">
              <b-form-group label="Telegram Notifications">
                <b-form-checkbox
                  v-model="warehouse.telegram_enabled"
                  :switch="true"
                >
