                            ...
                            <b-col md="12">
                              <label class="checkbox checkbox-outline-primary">
                                <input
                                  ...
                                  checked
                                  v-model="permissions"
                                  value="sales_by_seller_report"
                                >
                                <span>{{$t('SalesBySellerReport')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                      ...
                      <b-card-body>
                        <b-card-text>
                          <b-row>
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_pos">
                                <span>POS</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_orders">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_products">
                                <span>ផលិតផល</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_sale_returns">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_profile">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_reports">
                                <span>របាយការណ៍</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_seller_alerts">
                      ...
                      <b-card-body>
                        <b-card-text>
                          <b-row>
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_delivery_record_items">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_delivery_record_reports">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_delivery_deliveries">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_delivery_reports">
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_delivery_profile">
                                <span>ប្រវត្តិរូប</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_delivery_alerts">
                                <span>ការជូនដំណឹង</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
