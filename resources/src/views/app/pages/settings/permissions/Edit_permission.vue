                      ...
                      <b-card-body>
                        <b-card-text>
                          ...
                          <b-row>
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_products_view">
                                <span>{{$t('View')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_products_create">
                                <span>{{$t('Create')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_products_edit">
                                <span>{{$t('Edit')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
                            ...
                            <b-col md="6" class="mb-2">
                              <label class="checkbox checkbox-outline-primary d-block">
                                <input type="checkbox" v-model="permissions" value="mobile_products_delete">
                                <span>{{$t('Delete')}}</span>
                                <span class="checkmark"></span>
                              </label>
                            </b-col>
