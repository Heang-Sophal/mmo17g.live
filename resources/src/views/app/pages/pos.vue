          ...
          <div class="summary-section">
            ...
            <div class="charges-section">
              ...
              <div class="charge-row no-border-bottom">
                ...
                <div class="charge-input-group">
                  <input v-model.number="sale.shipping" type="text" placeholder="2" required @keyup="keyup_Shipping" class="flat-input" />
...
export default {
  ...
  methods: {
    ...
    _cd_queue_broadcast() {
      ...
      this._cd_broadcast_timer = setTimeout(() => {
        const payload = {
          ...
          shipping: this.normalizeShippingAmount(this.sale && this.sale.shipping),
    ...
    Create_Draft(){
      ...
      const shipping = this.ensureShippingAmount();
      axios
    ...
    CalculTotal() {
      ...
      const shipping = this.normalizeShippingAmount(this.sale.shipping);
    ...
    getDefaultShippingAmount() {
      return 2;
    },

    normalizeShippingAmount(value) {
    ...
    loadDraftSale(id) {
      ...
      axios
        ...
        .then(response => {
          ...
          this.sale.shipping = this.normalizeShippingAmount(saleData.shipping);
        ...
        for (let i = 0; i < queue.length; i++) {
          ...
          try {
            ...
            const payload = {
              ...
              offline_id: sale.id,
              shipping: this.normalizeShippingAmount(basePayload.shipping),
