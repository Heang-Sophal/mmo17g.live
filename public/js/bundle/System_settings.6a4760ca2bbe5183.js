...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return _ref = {
    ...
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_ref, "customFieldsActiveTab", 0), "customerFields", []), "supplierFields", []), "customFieldsTableKey", 0), "customFieldEditmode", false), "customFieldSubmitProcessing", false), "customField", {
      id: "",
      name: "",
      field_type: "",
      entity_type: "",
      ...
      default_value: "",
      sort_order: 0
    }), "selectOptionsText", ""), "firebaseAppType", 'seller'), "firebaseStatuses", {
      seller: {
        configured: null,
        project_id: ""
      },
    ...
    }), _defineProperty(_defineProperty(_defineProperty(_ref, "firebaseStatus", {
      configured: null,
      project_id: ""
    }), "firebase_credentials_file", null), "firebaseSubmitting", false);
  },
  computed: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)("config", ["getThemeMode"])), (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser", "getSidebarLayout", "getSideBarToggleProperties"])), {}, {
    ...
    tabs: function tabs() {
      ...
      var baseTabs = [{
        ...
        label: this.$t('Push_Notifications') || 'Push Notifications',
        icon: 'i-Bell',
        description: 'Configure Firebase for mobile push notifications'
      }];
  ...
  methods: _objectSpread(_objectSpread({
    ...
    Get_Firebase_Status: function Get_Firebase_Status() {
      var _this = this;
      axios.get('settings/firebase_status', {
        params: {
          app_type: 'all'
        }
      }).then(function (response) {
        _this.firebaseStatuses = response.data || {
          seller: {
            configured: false,
            project_id: ''
          },
        ...
        _this.firebaseStatus = _this.firebaseStatuses[_this.firebaseAppType] || {
          configured: false,
          project_id: ''
        };
      })["catch"](function () {
        _this.firebaseStatuses = {
          seller: {
            configured: false,
            project_id: ''
          },
        ...
        _this.firebaseStatus = {
          configured: false,
          project_id: ''
        };
      });
    },
    Submit_Firebase_Settings: function Submit_Firebase_Settings() {
      var _this2 = this;
      this.$refs.firebase_credentials.validate().then(function (success) {
        if (!success || !_this2.firebase_credentials_file) {
          _this2.makeToast("danger", _this2.$t("Please_select_a_valid_JSON_file") || "Please select a valid JSON file.", _this2.$t("Failed"));
          return;
        }
        _this2.firebaseSubmitting = true;
        var formData = new FormData();
        formData.append('firebase_credentials', _this2.firebase_credentials_file);
        formData.append('app_type', _this2.firebaseAppType);
        axios.post('settings/firebase_credentials', formData, {
          ...
          _this2.Get_Firebase_Status();
          _this2.firebase_credentials_file = null;
        })["catch"](function (error) {
          var msg = error.response && error.response.data && error.response.data.message || _this2.$t("InvalidData");
          _this2.makeToast("danger", msg, _this2.$t("Failed"));
        })["finally"](function () {
          _this2.firebaseSubmitting = false;
        });
      });
    },
    // ---------------- Security Settings ----------------
    ...
    LoadSecuritySessions: function LoadSecuritySessions() {
      ...
      axios.get("security/sessions").then(function (response) {
        _this3.securitySessions = response && response.data && response.data.sessions ? response.data.sessions : [];
      })["catch"](function (error) {
        ...
        _this3.securitySessionsLoading = false;
      });
    },
    LogoutSession: function LogoutSession(tokenId) {
      ...
      axios["delete"]("security/sessions/".concat(encodeURIComponent(tokenId))).then(function () {
        _this4.makeToast("success", "Session logged out successfully.", _this4.$t("Success"));
    ...
    LogoutAllOtherDevices: function LogoutAllOtherDevices() {
      ...
      axios.post("security/sessions/logout-other").then(function (response) {
        ...
        _this5.makeToast("success", msg, _this5.$t("Success"));
        _this5.LoadSecuritySessions();
      })["catch"](function (error) {
        var msg = error && error.response && error.response.data && (error.response.data.message || error.response.data.error) || _this5.$t("Failed");
        _this5.makeToast("danger", msg, _this5.$t("Failed"));
      })["finally"](function () {
        _this5.securitySessionsActionLoading = false;
      });
    },
    Load_Calendar_Settings: function Load_Calendar_Settings() {
      ...
      axios.get("settings/calendar").then(function (response) {
        ...
        if (d) {
          _this6.calendarForm.google_calendar_connected = !!d.google_calendar_connected;
          _this6.calendarForm.google_calendar_connect_url = d.google_calendar_connect_url || "";
          _this6.calendarForm.google_calendar_disconnect_url = d.google_calendar_disconnect_url || "";
          _this6.calendarForm.google_calendar_client_id = d.google_calendar_client_id || "";
          _this6.calendarForm.google_calendar_client_secret = "";
          _this6.calendarForm.google_calendar_client_secret_set = !!d.google_calendar_client_secret_set;
          _this6.calendarForm.google_calendar_redirect_uri = d.google_calendar_redirect_uri || "";
          _this6.calendarForm.google_calendar_calendar_id = d.google_calendar_calendar_id || "";
        }
      })["catch"](function () {
        _this6.makeToast("danger", _this6.$t("Failed") || "Failed", _this6.$t("Failed"));
      });
    },
    Submit_Calendar_Settings: function Submit_Calendar_Settings() {
      ...
      axios.patch("settings/calendar", {
        ...
        _this7.makeToast("success", _this7.$t("Success") || "Saved", _this7.$t("Success"));
      })["catch"](function (error) {
        var msg = error && error.response && error.response.data && (error.response.data.message || error.response.data.errors) || _this7.$t("Failed");
        _this7.makeToast("danger", _typeof(msg) === "object" ? JSON.stringify(msg) : msg, _this7.$t("Failed"));
      })["finally"](function () {
        _this7.calendarSaving = false;
      });
    }
      ...
      if (this.$refs.appearanceObserver && this.$refs.appearanceObserver.validate) {
        this.$refs.appearanceObserver.validate().then(function (success) {
          if (!success) {
            ...
            _this1.Update_Appearance_Settings();
          }
        });
      } else {
    ...
    normalizeSelectedFile: function normalizeSelectedFile(fileOrFiles) {
      if (!fileOrFiles) {
        return null;
      }
    ...
    buildImageFilename: function buildImageFilename(originalName, mimeType) {
      ...
      var extension = extensionMap[mimeType] || "png";
      return "".concat(baseName, ".").concat(extension);
    },
    loadImageElement: function loadImageElement(file) {
    ...
    canvasToBlob: function canvasToBlob(canvas, mimeType, quality) {
      return new Promise(function (resolve, reject) {
    ...
    optimizeImageUpload: function optimizeImageUpload(fileOrFiles) {
      var _arguments = arguments,
        _this10 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var options, file, _options$maxWidth, maxWidth, _options$maxHeight, maxHeight, _options$outputType, outputType, _options$qualitySteps, qualitySteps, _options$maxBytes, maxBytes, _options$label, label, image, width, height, ratio, targetWidth, targetHeight, canvas, ctx, bestBlob, _iterator, _step, quality, blob, _t, _t2;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              options = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : {};
              file = _this10.normalizeSelectedFile(fileOrFiles);
              if (file) {
                _context.n = 1;
                break;
              }
            ...
            case 1:
              ...
              _this10.makeToast("danger", _this10.$t("Invalid_file_type"), _this10.$t("Failed"));
              return _context.a(2, null);
            case 2:
              _options$maxWidth = options.maxWidth, maxWidth = _options$maxWidth === void 0 ? 1024 : _options$maxWidth, _options$maxHeight = options.maxHeight, maxHeight = _options$maxHeight === void 0 ? 1024 : _options$maxHeight, _options$outputType = options.outputType, outputType = _options$outputType === void 0 ? "image/webp" : _options$outputType, _options$qualitySteps = options.qualitySteps, qualitySteps = _options$qualitySteps === void 0 ? [0.9, 0.82, 0.74, 0.66] : _options$qualitySteps, _options$maxBytes = options.maxBytes, maxBytes = _options$maxBytes === void 0 ? 512 * 1024 : _options$maxBytes, _options$label = options.label, label = _options$label === void 0 ? "image" : _options$label;
              _context.p = 3;
              _context.n = 4;
              return _this10.loadImageElement(file);
            case 4:
              image = _context.v;
              width = image.naturalWidth || image.width;
              height = image.naturalHeight || image.height;
              ratio = Math.min(1, maxWidth / width, maxHeight / height);
              ...
              bestBlob = null;
              _iterator = _createForOfIteratorHelper(qualitySteps);
              _context.p = 5;
              _iterator.s();
            case 6:
              ...
              quality = _step.value;
              _context.n = 7;
              return _this10.canvasToBlob(canvas, outputType, quality);
            case 7:
              blob = _context.v;
              ...
              return _context.a(2, new File([blob], _this10.buildImageFilename(file.name, outputType), {
                type: outputType
              }));
            case 8:
              _context.n = 6;
            ...
            case 12:
              ...
              if (bestBlob.size > maxBytes) {
                _this10.makeToast("warning", "".concat(label, " was optimized before upload because the original file was too large."), _this10.$t("Success"));
              }
              return _context.a(2, new File([bestBlob], _this10.buildImageFilename(file.name, outputType), {
                type: outputType
              }));
            case 13:
              _context.n = 15;
            ...
            case 14:
              _context.p = 14;
              _t2 = _context.v;
              _this10.makeToast("danger", "Unable to process ".concat(label.toLowerCase(), " file."), _this10.$t("Failed"));
            case 15:
              return _context.a(2, null);
          }
        }, _callee, null, [[5, 10, 11, 12], [3, 14]]);
      }))();
    },
    //------------------------------ Event Upload Logo -------------------------------\\
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              _this11.makeToast("danger", _this11.$t("Invalid_file_type"), _this11.$t("Failed"));
              e.target.value = '';
              _this11.setting.logo = "";
            ...
            case 1:
              ...
              _this11.makeToast("danger", _this11.$t("File_size_must_be_less_than_200KB"), _this11.$t("Failed"));
              e.target.value = '';
              _this11.setting.logo = "";
              return _context2.a(2);
            case 2:
              _this11.setting.logo = file;
              _context2.n = 4;
              break;
            case 3:
              _this11.setting.logo = "";
    ...
    onAppearanceLogoSelected: function onAppearanceLogoSelected(e) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _yield$_this12$$refs$, valid, file;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _context3.n = 1;
              return _this12.$refs.AppearanceLogo.validate(e);
            case 1:
              _yield$_this12$$refs$ = _context3.v;
              valid = _yield$_this12$$refs$.valid;
              file = e.target.files[0];
              if (!(valid && file)) {
                _context3.n = 3;
                break;
              ...
              _context3.n = 2;
              return _this12.optimizeImageUpload(file, {
                maxWidth: 800,
                maxHeight: 800,
            ...
            case 2:
              _this12.appearance_settings.logo = _context3.v;
              _context3.n = 4;
              break;
            case 3:
              _this12.appearance_settings.logo = "";
            case 4:
    ...
    onAppearanceFaviconSelected: function onAppearanceFaviconSelected(e) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var _yield$_this13$$refs$, valid, file;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              _context4.n = 1;
              return _this13.$refs.AppearanceFavicon.validate(e);
            case 1:
              _yield$_this13$$refs$ = _context4.v;
              valid = _yield$_this13$$refs$.valid;
              file = e.target.files[0];
              if (!(valid && file)) {
                _context4.n = 3;
                break;
              ...
              _context4.n = 2;
              return _this13.optimizeImageUpload(file, {
                maxWidth: 256,
                maxHeight: 256,
            ...
            case 2:
              _this13.appearance_settings.favicon = _context4.v;
              _context4.n = 4;
              break;
            case 3:
              _this13.appearance_settings.favicon = "";
            case 4:
    ...
    onSellerMobileAppLogoSelected: function onSellerMobileAppLogoSelected(file) {
      var _this14 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              _context5.n = 1;
              return _this14.optimizeImageUpload(file, {
                maxWidth: 512,
                maxHeight: 512,
                outputType: "image/webp",
                maxBytes: 350 * 1024,
            ...
            case 1:
              optimizedFile = _context5.v;
              _this14.appearance_settings.seller_mobile_app_logo_file = optimizedFile;
              if (optimizedFile) {
                _this14.appearance_settings.seller_mobile_app_logo_url = URL.createObjectURL(optimizedFile);
              }
            case 2:
    ...
    onDeliveryMobileAppLogoSelected: function onDeliveryMobileAppLogoSelected(file) {
      var _this15 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              _context6.n = 1;
              return _this15.optimizeImageUpload(file, {
                maxWidth: 512,
                maxHeight: 512,
                outputType: "image/webp",
                maxBytes: 350 * 1024,
            ...
            case 1:
              optimizedFile = _context6.v;
              _this15.appearance_settings.delivery_mobile_app_logo_file = optimizedFile;
              if (optimizedFile) {
                _this15.appearance_settings.delivery_mobile_app_logo_url = URL.createObjectURL(optimizedFile);
              }
            case 2:
    ...
    Update_Settings: function Update_Settings() {
      ...
      axios.post("settings/" + self.setting.id, self.data).then(function (response) {
        ...
        if (self.setting.dark_mode !== undefined && self.setting.dark_mode !== null) {
          _this16.$store.state.config.themeMode.dark = self.setting.dark_mode;
        }
        if (self.setting.rtl !== undefined && self.setting.rtl !== null) {
          _this16.$store.state.config.themeMode.rtl = self.setting.rtl;
        }
        ...
        try {
          if (self.setting.date_format) {
            ...
            _this16.$store.commit('setDateFormat', self.setting.date_format);
        ...
        _this16.refreshUserPermissions();
        ...
        _this16.SetLocal(self.setting.default_language);
      })["catch"](function (error) {
        var msg = error && error.response && error.response.data && (error.response.data.message || error.response.data.error) || _this16.$t("InvalidData");
        _this16.makeToast("danger", msg, _this16.$t("Failed"));
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      });
    },
    ...
    Get_Payment_Gateway: function Get_Payment_Gateway() {
      ...
      axios.get("get_payment_gateway_ws").then(function (response) {
        _this18.gateway = response.data.gateway;
      })["catch"](function (error) {
    ...
    Get_Pos_Settings: function Get_Pos_Settings() {
      ...
      axios.get("get_pos_Settings").then(function (response) {
        _this20.pos_settings = _objectSpread(_objectSpread({}, _this20.pos_settings), response.data.pos_settings || {});
        // Ensure show_tax and show_shipping have default values if not present
        if (_this20.pos_settings.show_tax === undefined || _this20.pos_settings.show_tax === null || _this20.pos_settings.show_tax === '') {
          _this20.pos_settings.show_tax = _this20.pos_settings.show_discount || 0;
        }
        if (_this20.pos_settings.show_shipping === undefined || _this20.pos_settings.show_shipping === null || _this20.pos_settings.show_shipping === '') {
          _this20.pos_settings.show_shipping = _this20.pos_settings.show_discount || 0;
        }
        // Ensure logo_size has a default value if not present
        if (_this20.pos_settings.logo_size === undefined || _this20.pos_settings.logo_size === null || _this20.pos_settings.logo_size === '') {
          _this20.pos_settings.logo_size = 60;
        }
        // Set logoSizeType based on logo_size value
        var size = Number(_this20.pos_settings.logo_size);
        if (size === 40) {
          _this20.logoSizeType = 'small';
        } else if (size === 60) {
          _this20.logoSizeType = 'medium';
        } else if (size === 80) {
          _this20.logoSizeType = 'large';
        } else {
          _this20.logoSizeType = 'custom';
        }
      })["catch"](function (error) {
    ...
    submitTermiSMS: function submitTermiSMS() {
      ...
      axios.post("update_termi_config", {
        ...
        try {
          if (typeof window !== 'undefined' && window.localStorage) {
            window.localStorage.setItem('system_settings_submitted_tab', _this23.activeTab);
          }
        } catch (e) {}
    ...
    submitTwilioSMS: function submitTwilioSMS() {
      ...
      axios.post("update_twilio_config", {
        ...
        try {
          if (typeof window !== 'undefined' && window.localStorage) {
            window.localStorage.setItem('system_settings_submitted_tab', _this25.activeTab);
          }
        } catch (e) {}
    ...
    Get_SMS_Settings: function Get_SMS_Settings() {
      ...
      axios.get("get_sms_config").then(function (response) {
        _this27.sms_settings.twilio = response.data.twilio || _this27.sms_settings.twilio;
        _this27.sms_settings.termi = response.data.termi || _this27.sms_settings.termi;
        _this27.sms_settings.infobip = response.data.infobip || _this27.sms_settings.infobip;
        _this27.sms_settings.sms_gateway = response.data.sms_gateway || [];
        _this27.sms_settings.default_sms_gateway = response.data.default_sms_gateway || '';
      })["catch"](function (error) {
    ...
    Update_Appearance_Settings: function Update_Appearance_Settings() {
      ...
      axios.post("update_appearance_settings/" + self.appearance_settings.id, self.appearance_data).then(function (response) {
        ...
        _this28.makeToast("success", _this28.$t("Successfully_Updated"), _this28.$t("Success"));
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        ...
        var statusCode = error === null || error === void 0 || (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status;
        var responseMessage = error === null || error === void 0 || (_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message;
        var validationErrors = error === null || error === void 0 || (_error$response3 = error.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.errors;
        var firstValidationMessage = validationErrors ? Object.values(validationErrors).flat()[0] : null;
        _this28.makeToast("danger", statusCode === 413 ? "Uploaded images are too large. Please choose the files again and they will be optimized automatically." : firstValidationMessage || responseMessage || _this28.$t("InvalidData"), _this28.$t("Failed"));
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      });
    },
    ...
    Get_Appearance_Settings: function Get_Appearance_Settings() {
      ...
      axios.get("get_appearance_settings").then(function (response) {
        _this29.appearance_settings = _objectSpread(_objectSpread({}, _this29.appearance_settings), response.data.settings || {});
      })["catch"](function (error) {
    ...
    Update_Mail_Settings: function Update_Mail_Settings() {
      ...
      if (this.$refs.mailObserver && this.$refs.mailObserver.validate) {
        this.$refs.mailObserver.validate().then(function (success) {
          if (!success) {
            _this30.makeToast("danger", _this30.$t("Please_fill_the_form_correctly"), _this30.$t("Failed"));
            return;
          }
          _this30.submitMailSettings();
        });
      } else {
    ...
    submitMailSettings: function submitMailSettings() {
      ...
      return axios.put("update_config_mail/" + this.mail_settings.id, {
        ...
        try {
          if (typeof window !== 'undefined' && window.localStorage) {
            window.localStorage.setItem('system_settings_submitted_tab', _this31.activeTab);
          }
        } catch (e) {}
        if (!silent) {
          _this31.makeToast("success", _this31.$t("Successfully_Updated"), _this31.$t("Success"));
        }
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        return response;
      })["catch"](function (error) {
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        if (!silent) {
          _this31.makeToast("danger", _this31.$t("InvalidData"), _this31.$t("Failed"));
        }
        throw error;
      });
    },
    ...
    Get_Mail_Settings: function Get_Mail_Settings() {
      ...
      axios.get("get_config_mail").then(function (response) {
        _this32.mail_settings = response.data.server || _this32.mail_settings;
      })["catch"](function (error) {
    ...
    Test_Mail_Settings: function Test_Mail_Settings() {
      ...
      if (this.$refs.mailObserver && this.$refs.mailObserver.validate) {
        this.$refs.mailObserver.validate().then(function (success) {
          ...
          _this33.isTestingMail = true;
          nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
          nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);

          // Save settings first (silently, without showing success toast)
          _this33.submitMailSettings(true).then(function () {
            // After saving, test the mail
            return axios.post("test_config_mail");
          }).then(function (response) {
            var msg = response.data && (response.data.message || response.data.msg) || _this33.$t("Successfully_Updated");
            _this33.makeToast("success", msg, _this33.$t("Success"));
          })["catch"](function (error) {
            var msg = error.response && error.response.data && (error.response.data.message || error.response.data.errors) || _this33.$t("InvalidData");
            _this33.makeToast("danger", msg, _this33.$t("Failed"));
          })["finally"](function () {
            _this33.isTestingMail = false;
            nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
          });
        });
      } else {
    ...
    GenerateBackup: function GenerateBackup() {
      ...
      axios.get("generate_new_backup").then(function (response) {
        ...
        if (response.data && response.data.success === false) {
          ...
          var errorMsg = response.data.error || response.data.message || _this34.$t("Failed_to_generate_backup") || "Failed to generate backup";

          // Check if it's a mysqldump not found error
          if (errorMsg.includes('mysqldump') && errorMsg.includes('not found')) {
            _this34.backupError = true;
          }
          _this34.makeToast("danger", errorMsg, _this34.$t("Failed"));
        } else {
          // Clear any previous errors on success
          _this34.backupError = null;
          // Backup successful
          var message = _this34.$t("Backup_generated_successfully") || "Backup generated successfully";
          _this34.makeToast("success", message, _this34.$t("Success"));
        }
        setTimeout(function () {
        ...
        var errorMsg = _this34.$t("Failed_to_generate_backup") || "Failed to generate backup";
    ...
    Get_Backups: function Get_Backups() {
      ...
      axios.get("get_backup").then(function (response) {
        _this35.backups = response.data.backups || [];
        _this35.totalRows = response.data.totalRows || 0;
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      ...
      this.$swal({
        ...
        if (result.value) {
          axios["delete"]("delete_backup/" + date).then(function () {
            _this36.$swal(_this36.$t("Delete_Deleted"), _this36.$t("Deleted_in_successfully"), "success");
            Fire.$emit("Delete_Backup");
          })["catch"](function () {
            _this36.$swal(_this36.$t("Delete_Failed"), _this36.$t("Delete_Therewassomethingwronge"), "warning");
          });
        }
      });
    },
    ...
    Clear_Cache: function Clear_Cache() {
      ...
      axios.get("clear_cache").then(function (response) {
        _this37.makeToast("success", _this37.$t("Cache_cleared_successfully"), _this37.$t("Success"));
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      })["catch"](function (error) {
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        _this37.makeToast("danger", _this37.$t("Failed_to_clear_cache"), _this37.$t("Failed"));
      });
    },
    //---------------------------------- Get SETTINGS ----------------\\
    Get_Settings: function Get_Settings() {
      ...
      axios.get("get_Settings_data_api", {
        ...
        _this38.setting = _objectSpread(_objectSpread({}, _this38.setting), response.data.settings || {});
        // Update date_format in Vuex store and localStorage cache
        try {
          if (_this38.setting.date_format) {
            // Update Vuex store (primary source from database)
            _this38.$store.commit('setDateFormat', _this38.setting.date_format);
            // Also update localStorage as cache
            localStorage.setItem('app_date_format', _this38.setting.date_format);
          }
        } catch (e) {}
        // Cache price_format in localStorage for frontend-only display helpers (e.g., POS)
        try {
          if (_this38.setting.price_format) {
            (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_2__.cachePriceFormat)(_this38.setting.price_format);
          }
        } catch (e) {}
        // If current timeout is a custom value, keep it in the custom input
        try {
          var stm = Number(_this38.setting.session_timeout_minutes);
          if (!isNaN(stm) && stm > 0 && ![15, 30, 60].includes(stm)) {
            _this38.sessionTimeoutCustom = stm;
          }
        } catch (e) {}

        // Sync dark_mode and rtl with Vuex store if they exist in settings
        // If not in settings, use current Vuex store values
        if (_this38.setting.dark_mode !== undefined && _this38.setting.dark_mode !== null) {
          // Sync Vuex store with backend setting by directly setting the value
          if (_this38.getThemeMode.dark !== _this38.setting.dark_mode) {
            _this38.$store.state.config.themeMode.dark = _this38.setting.dark_mode;
          }
        } else {
          // If not in backend, initialize from Vuex store
          _this38.setting.dark_mode = _this38.getThemeMode.dark || false;
        }
        if (_this38.setting.rtl !== undefined && _this38.setting.rtl !== null) {
          // Sync Vuex store with backend setting by directly setting the value
          if (_this38.getThemeMode.rtl !== _this38.setting.rtl) {
            _this38.$store.state.config.themeMode.rtl = _this38.setting.rtl;
          }
        } else {
          // If not in backend, initialize from Vuex store
          _this38.setting.rtl = _this38.getThemeMode.rtl || false;
        }
        _this38.currencies = response.data.currencies;
        _this38.clients = response.data.clients;
        _this38.warehouses = response.data.warehouses;
        _this38.sms_gateway = response.data.sms_gateway;
        _this38.accounts = response.data.accounts || [];
        _this38.payment_methods = response.data.payment_methods || [];
        _this38.zones_array = response.data.zones_array;
        _this38.languages = response.data.languages;
    ...
    Get_CustomFields: function Get_CustomFields() {
      ...
      var customerPromise = axios.get("custom-fields?entity_type=client").then(function (response) {
        _this39.customerFields = response.data.custom_fields || [];
      })["catch"](function (error) {
      ...
      var supplierPromise = axios.get("custom-fields?entity_type=provider").then(function (response) {
        _this39.supplierFields = response.data.custom_fields || [];
      })["catch"](function (error) {
    ...
    New_CustomField: function New_CustomField(entityType) {
      ...
      setTimeout(function () {
        _this40.$bvModal.show("New_CustomField");
      }, 500);
    },
    Edit_CustomField: function Edit_CustomField(customField) {
      ...
      setTimeout(function () {
        _this41.$bvModal.show("Edit_CustomField");
      }, 500);
    },
    Submit_CustomField: function Submit_CustomField() {
      ...
      this.$refs.Create_CustomField.validate().then(function (success) {
        if (!success) {
          _this42.makeToast("danger", _this42.$t("Please_fill_the_form_correctly"), _this42.$t("Failed"));
          return;
        }
        _this42.customFieldSubmitProcessing = true;
        var payload = {
          name: _this42.customField.name,
          field_type: _this42.customField.field_type,
          entity_type: _this42.customField.entity_type,
          is_required: _this42.customField.is_required,
          is_active: _this42.customField.is_active !== undefined ? _this42.customField.is_active : true,
          default_value: _this42.customField.default_value || null,
          sort_order: _this42.customField.sort_order || 0
        };

        // Handle select options
        if (_this42.customField.field_type === 'select') {
          var options = _this42.selectOptionsText.split('\n').map(function (opt) {
            return opt.trim();
          }).filter(function (opt) {
            return opt.length > 0;
          });
        ...
        var url = _this42.customFieldEditmode ? "custom-fields/".concat(_this42.customField.id) : "custom-fields";
        var method = _this42.customFieldEditmode ? "put" : "post";
        axios[method](url, payload).then(function (response) {
          _this42.makeToast("success", _this42.customFieldEditmode ? _this42.$t("Successfully_Updated") : _this42.$t("Successfully_Created"), _this42.$t("Success"));
          _this42.customFieldSubmitProcessing = false;
          _this42.$bvModal.hide(_this42.customFieldEditmode ? "Edit_CustomField" : "New_CustomField");
          _this42.Get_CustomFields().then(function () {
            // Force table re-render after data is refreshed
            _this42.$nextTick(function () {
              _this42.customFieldsTableKey += 1;
            });
          });
        })["catch"](function (error) {
          _this42.customFieldSubmitProcessing = false;
          _this42.makeToast("danger", _this42.$t("InvalidData"), _this42.$t("Failed"));
        });
      });
    },
      ...
      this.$swal({
        ...
        if (result.value) {
          axios["delete"]("custom-fields/" + id).then(function (response) {
            _this43.makeToast("success", _this43.$t("Deleted_in_successfully"), _this43.$t("Success"));
            // Remove the item from local arrays immediately (optimistic update)
            _this43.customerFields = _this43.customerFields.filter(function (field) {
              return field.id !== id;
            });
            _this43.supplierFields = _this43.supplierFields.filter(function (field) {
              return field.id !== id;
            });
