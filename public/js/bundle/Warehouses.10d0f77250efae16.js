  ...
  methods: {
    ...
    Create_Warehouse: function Create_Warehouse() {
      ...
      axios.post("warehouses", {
        ...
        telegram_bot_token: this.warehouse.telegram_bot_token,
        telegram_chat_id: this.warehouse.telegram_chat_id,
        telegram_enabled: this.warehouse.telegram_enabled ? 1 : 0
...
var render = function render() {
  ...
  return _c("div", {
    ...
    model: {
      value: _vm.warehouse.telegram_bot_token,
      callback: function callback($$v) {
        _vm.$set(_vm.warehouse, "telegram_bot_token", $$v);
      },
      expression: "warehouse.telegram_bot_token"
    }
  }), _vm._v(" "), _c("small", {
    staticClass: "form-text text-muted"
  }, [_vm._v("Get from @BotFather on Telegram")])], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6"
    }
  }, [_c("b-form-group", {
    ...
    model: {
      value: _vm.warehouse.telegram_chat_id,
      callback: function callback($$v) {
        _vm.$set(_vm.warehouse, "telegram_chat_id", $$v);
      },
      expression: "warehouse.telegram_chat_id"
    }
  }), _vm._v(" "), _c("small", {
    staticClass: "form-text text-muted"
  }, [_vm._v("Get Chat ID from @userinfobot on Telegram")])], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6"
    }
  }, [_c("b-form-group", {
    ...
    model: {
      value: _vm.warehouse.telegram_enabled,
      callback: function callback($$v) {
        _vm.$set(_vm.warehouse, "telegram_enabled", $$v);
      },
      expression: "warehouse.telegram_enabled"
    }
  }, [_vm._v("\n                Enable Telegram notifications for this warehouse\n              ")])], 1)], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6"
    }
  }, [_c("b-form-group", {
